...
The application’s API, retrieves data from the GitHub API, has already been created. It's your job to complete the front end using tsx, call the application's API, and then deploy the entire application to Render.
